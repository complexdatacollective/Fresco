...
import { type ImportJob } from './protocolImportStore';
import { useProtocolImportStore } from './useProtocolImportStore';
          ...
          <ScrollArea className="-mx-6 flex-1 px-6" fade>
            <AnimatePresence mode="popLayout" initial={false}>
              {hasJobs ? (
                ...
                >
                  <div className="bg-surface-contrast/5 mb-4 flex size-20 items-center justify-center rounded-full">
                    <FileDown className="text-surface-contrast/30 size-10" />
                  </div>
