      ...
      if ((data && typeof data === "object" && !Array.isArray(data))) {
        ...
        if (data1 !== undefined) {
          ...
          if ((data1 && typeof data1 === "object" && !Array.isArray(data1))) {
            ...
            if (data1.greaterThanVariable !== undefined) {
              var errs_3 = errors;
              if (typeof data1.greaterThanVariable !== "string") {
                var err = {
                  keyword: 'type',
                  dataPath: (dataPath || '') + '.validation.greaterThanVariable',
                  schemaPath: '#/definitions/Validation/properties/greaterThanVariable/type',
                  params: {
                    type: 'string'
                  },
                  message: 'should be string'
            ...
            if (data1.lessThanVariable !== undefined) {
              var errs_3 = errors;
              if (typeof data1.lessThanVariable !== "string") {
                var err = {
                  keyword: 'type',
                  dataPath: (dataPath || '') + '.validation.lessThanVariable',
                  schemaPath: '#/definitions/Validation/properties/lessThanVariable/type',
                  params: {
                    type: 'string'
                  },
                  message: 'should be string'
      ...
      if ((data && typeof data === "object" && !Array.isArray(data))) {
        ...
        if (data1 !== undefined) {
          ...
          if (Array.isArray(data1)) {
            ...
            for (var i1 = 0; i1 < data1.length; i1++) {
              var errs_2 = errors;
              if (!refVal31(data1[i1], (dataPath || '') + '.presets[' + i1 + ']', data1, i1, rootData)) {
        ...
        if (data1 !== undefined) {
          ...
          if (Array.isArray(data1)) {
            ...
            for (var i1 = 0; i1 < data1.length; i1++) {
              var errs_2 = errors;
              if (!refVal34(data1[i1], (dataPath || '') + '.sortOptions[' + i1 + ']', data1, i1, rootData)) {
          ...
          if ((data1 && typeof data1 === "object" && !Array.isArray(data1))) {
            if (Object.keys(data1).length < 1) {
              var err = {
                ...
                schemaPath: '#/definitions/Layout/minProperties',
                params: {
                  limit: 1
                },
            ...
            for (var key2 in data1) {
              if (pattern2.test(key2)) {
                ...
                if (typeof data1[key2] !== "string") {
                  var err = {
                    keyword: 'type',
                    dataPath: (dataPath || '') + '.layout[\'' + key2 + '\']',
                    schemaPath: '#/definitions/Layout/patternProperties/%5E%5B0-9%5D%2B%24/type',
                    params: {
                      type: 'string'
                    },
                    message: 'should be string'
            ...
            if (data2 !== undefined) {
              ...
              if ((data2 && typeof data2 === "object" && !Array.isArray(data2))) {
                ...
                if (data3 !== undefined) {
                  ...
                  var schema4 = refVal29.properties.restrict.properties.destination.enum;
                  var valid4;
                  valid4 = false;
                  for (var i4 = 0; i4 < schema4.length; i4++)
                    if (equal(data3, schema4[i4])) {
            ...
            if (data2 !== undefined) {
              ...
              if ((data2 && typeof data2 === "object" && !Array.isArray(data2))) {
                ...
                if (data3 !== undefined) {
                  ...
                  var schema4 = refVal[29].properties.restrict.properties.destination.enum;
                  var valid4;
                  valid4 = false;
                  for (var i4 = 0; i4 < schema4.length; i4++)
                    if (equal(data3, schema4[i4])) {
