...
import { getPromptOtherVariable, getStageSubject, getPromptVariable, stagePromptIds, getPropPromptId } from './prop';
...
export const makeGetVariableOptions = (includeOtherVariable = false) => createSelector(
  makeGetNodeVariables(), getPromptVariable, getPromptOtherVariable,
  (
    nodeVariables,
    promptVariable,
