...
export const getEdgeVariables = createSelector(
  getProtocolCodebook,
  getSubjectType,
  (codebook, edgeType) => {
...
export const makeGetEdgeVariables = () => getEdgeVariables;

export const getVariableOptions = createSelector(
  (state, props) => {
  ...
  (variables, variable) => variables[variable]?.options || [],
);
