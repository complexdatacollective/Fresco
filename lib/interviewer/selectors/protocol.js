...
const getLastActiveProtocol = (state) => {
...
const getActiveProtocolName = createSelector(
...
export const getAssetManifest = createSelector(
  getCurrentSessionProtocol,
  (protocol) => protocol.assets.reduce((manifest, asset) => {
...
const makeGetCodebookVariablesForType = () =>
  getCodebookVariablesForType;
