...
const stageIndexForCurrentSession = (state) => {
  console.log('TODO 1: lib/interviewer/selectors/session.js: stageIndexForCurrentSession');
...
export const getSessionProgress = createSelector(
   ...
   */
  getProtocolStages, // includes extra 'finish' screen (not in preview mode)
...
export const getSessionStageSubject = () => createDeepEqualSelector(
