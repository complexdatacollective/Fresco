...
const makeGetPromptNodeModelData = () => getPromptModelData;
...
const getSortableFields = createSelector(
  stageSortOptions,
  (sortOptions) => (has(sortOptions, 'sortableProperties') ? sortOptions.sortableProperties : []),
);

const getInitialSortOrder = createSelector(
  stageSortOptions,
...
const makeGetNodeIconName = () => getNodeIconName;
