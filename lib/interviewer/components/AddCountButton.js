    ...
    <div className={`${baseClass}__background`}>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 280 240">
        ...
        <g>
          ...
          <path
            className={`${baseClass}__base-flash`}
            d="M 224 128 A 0.2,0.2 0 1,1 0,128"
            transform="rotate(-45 112 128)"
          />
          <ellipse
            className={`${baseClass}__badge`}
            cx="224.5"
            cy="56"
            rx="55.5"
            ry="56"
          ...
          <rect
            ...
            width="8"
            height="36"
            transform="translate(168.5 280.5) rotate(-90)"
          />
        </g>
      </svg>
    </div>
