...
const EnhancedNode = ({ allowDrag, label, meta, scrollDirection, ...nodeProps }) => {
  return (
    <DragSource
      allowDrag={allowDrag}
      meta={meta}
  ...
  return (
    <motion.div layout className="node-list">
      <AnimatePresence mode="sync">
        {sortedNodes.length === 0 && (<div className='h-full flex items-center justify-center'>No items to place. Click the down arrow to continue.</div>)}
