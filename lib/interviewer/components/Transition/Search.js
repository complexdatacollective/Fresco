...
import { getCSSVariableAsObject, getCSSVariableAsNumber } from '~/lib/ui/utils/CSSVariables';
...
class Search extends Component {
  ...
  runEnterTimeline(el) {
    ...
    const borderRadiusPx = getPxValue(getCssProp(elStyle, '--nc-border-radius'));
