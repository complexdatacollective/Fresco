...
const AddFamilyMember = ({ onCancel, onSave, isSelf }) => {
  ...
  return (
    <div className="add-family-member-form">
      <form onSubmit={handleSubmit}>
        <h2>{isSelf ? 'Add Your Information' : 'Add Family Member'}</h2>
        ...
        <button type="submit">{isSelf ? 'Save Your Information' : 'Add Family Member'}</button>
