...
import useSecureAddNode from '../hooks/useSecureAddNode';
import { usePassphrase } from '../utils/labelLogic';
...
const QuickAddForm = ({
  ...
  const require = usePassphrase();
  const addNode = useSecureAddNode();
