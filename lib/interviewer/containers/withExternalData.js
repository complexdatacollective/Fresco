...
import { get, includes, isNil, reduce, toNumber } from 'lodash';
...
import { getSessionMeta } from '../selectors/session';
      ...
      (consolidatedAttributes, attributeValue, attributeKey) => {
        ...
        switch (codebookType) {
          ...
          case ProtocolConsts.VariableType.scalar: {
            return {
              ...consolidatedAttributes,
              [attributeKey]: toNumber(attributeValue),
            };
          }
