...
import { simpleRenderToString } from '~/utils/simpleRenderToString';
...
const HyperList = ({
  ...
  const getItemSize = (item, listWidth) => {
    ...
    const sizingElement = simpleRenderToString(<div className="hyper-list__item"><ItemComponent {...props} /></div>);
