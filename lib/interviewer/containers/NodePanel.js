...
function NodePanel(props) {
  ...
  const handleDrop = (item) => {
    return onDrop(item, props.dataSource);
  }
...
class NodePanelOld extends PureComponent {
  componentDidMount() {
...
const getNodesForPanel = (state, props) => {
  ...
  const filterFunction = customFilter(props.filter);
...
export default withExternalData('externalDataSource', 'externalData')(NodePanel)
