...
import StageTransition from '../components/Transition/Stage';
...
class Protocol extends Component {
  ...
  render() {
    ...
    console.log('protocol screen', stage)
...
function mapStateToProps(state, ownProps) {
  ...
  const protocolStages = getProtocolStages(state);
  console.log('protocolstages', protocolStages, ownProps);
  ...
  console.log('mstop', { state, sessionId, stage, stageIndex, ownProps });
