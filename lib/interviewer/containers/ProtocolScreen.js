...
import { getCurrentStage, getStageIndex } from '../selectors/session';
...
const ProtocolScreen = () => {
  ...
  const stageIndex = useSelector(getStageIndex);

  console.log('protocol screen current stage', stageIndex);
