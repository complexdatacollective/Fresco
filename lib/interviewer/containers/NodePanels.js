...
import { deleteNode, removeNodeFromPrompt } from '../ducks/modules/session';
...
class NodePanels extends PureComponent {
  ...
  handleDrop = ({ meta }, dataSource) => {
    const { removeNodeFromPrompt, prompt, newNodeAttributes, deleteNode } =
      this.props;
    /**
...
const mapDispatchToProps = {
  removeNodeFromPrompt: removeNodeFromPrompt,
