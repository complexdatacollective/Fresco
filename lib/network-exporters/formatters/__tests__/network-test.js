...
const { unionOfNetworks, insertEgoIntoSessionNetworks } = require('../network');
  ...
  describe('unionOfNetworks', () => {
    it('joins nodes of two networks', () => {
      ...
      expect(unionSession.nodes).toEqual([
        { id: 1, [sessionProperty]: 456 },
        { id: 2, [sessionProperty]: 789 },
      ]);
    });
    ...
    it('joins egos of two networks', () => {
      ...
      expect(unionSession.ego).toEqual({ 456: { id: 1 }, 789: { id: 2 } });
    });
  });
