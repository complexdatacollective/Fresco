...
const network2 = {
  nodes: [
    generateEntity(
      { name: 'Person 1', is_Person: true, is_Organization: null },
      null,
      'node',
      'person',
    ),
    generateEntity(
      { name: 'Person 2', is_Person: true, is_Organization: null },
      null,
      'node',
      'person',
    ),
    generateEntity(
      { name: 'Org 1', is_Person: null, is_Organization: true },
      null,
      'node',
      'person',
    ),
    generateEntity(
      { name: 'Org 2', is_Person: null, is_Organization: true },
      null,
      'node',
      'person',
    ),
