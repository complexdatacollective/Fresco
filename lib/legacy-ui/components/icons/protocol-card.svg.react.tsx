      ...
      <g id="Server">
        ...
        <g id="NC-Flat">
          ...
          <circle
            ...
            r="83.7"
          />{' '}
          <circle className="fill-navy-taupe" cx="118.4" cy="188.9" r="44.1" />{' '}
          <g id="NC-Nodes">
            {' '}
            <rect
            ...
            />{' '}
            <circle className="fill-platinum" cx="123.4" cy="111.1" r="15.2" />{' '}
            <circle className="fill-platinum" cx="70.1" cy="163.2" r="22.1" />{' '}
            <circle
