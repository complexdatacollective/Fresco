...
describe('migrate v3 -> v4', () => {
  ...
  it('type names', () => {
    ...
    expect(nodeDefinitions.disallowedTypeDuplicate.name).toBe(
      'disallowed_type_name2',
    );
  ...
  it('variable names', () => {
    ...
    expect(variables.invalidExampleVariable.name).toBe(
      'variable_with_disallowed_characters',
    );
    expect(variables.invalidExampleVariableDuplicate.name).toBe(
      'variable_with_disallowed_characters2',
    );
    expect(variables.validExampleVariable.name).toBe(
      'variable_with-allowed:characters.',
    );
...
it.todo('migrate v4 -> v5');
it.todo('migrate v5 -> v6');
it.todo('migrate v6 -> v7');
it.todo('migrate v7 -> v8');
