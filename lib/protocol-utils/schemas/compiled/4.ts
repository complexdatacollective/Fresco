  ...
  definitions: {
    ...
    Stage: {
      ...
      anyOf: [
        ...
        {
          properties: { type: { const: 'AlterForm' } },
          required: ['form', 'introductionPanel'],
        },
        {
...
const schema157 = { type: 'object', title: 'AssetManifest' };
const formats0 = /\d+/;
const schema145 = {
  type: 'object',
  additionalProperties: false,
    ...
    if (data.type !== undefined) {
      ...
      if (
        ...
        const err6 = {
          ...
          keyword: 'enum',
          params: { allowedValues: schema149.properties.type.enum },
    ...
    if (data.component !== undefined) {
      ...
      if (
        ...
        const err8 = {
          ...
          keyword: 'enum',
          params: { allowedValues: schema149.properties.component.enum },
          message: 'must be equal to one of the allowed values',
        };
        if (vErrors === null) {
          vErrors = [err8];
    ...
    if (data.entity !== undefined) {
      ...
      if (!(data0 === 'edge' || data0 === 'node' || data0 === 'ego')) {
        const err4 = {
          ...
          keyword: 'enum',
          params: { allowedValues: schema162.enum },
          message: 'must be equal to one of the allowed values',
        };
        if (vErrors === null) {
          vErrors = [err4];
    ...
    if (data.type !== undefined) {
      ...
      if (!(data0 === 'alter' || data0 === 'ego' || data0 === 'edge')) {
        const err5 = {
          ...
          schemaPath: '#/properties/type/enum',
          keyword: 'enum',
          params: { allowedValues: schema165.properties.type.enum },
          message: 'must be equal to one of the allowed values',
        };
        if (vErrors === null) {
          vErrors = [err5];
        ...
        if (data2.operator !== undefined) {
          ...
          if (
            ...
            const err15 = {
              ...
              keyword: 'enum',
              params: { allowedValues: schema166.properties.operator.enum },
              message: 'must be equal to one of the allowed values',
            };
            if (vErrors === null) {
              vErrors = [err15];
        ...
        if (data2.value !== undefined) {
          ...
          if (
            ...
            const err16 = {
              ...
              keyword: 'type',
              params: { type: schema166.properties.value.type },
    ...
    if (data.join !== undefined) {
      ...
      if (!(data0 === 'OR' || data0 === 'AND')) {
        const err3 = {
          ...
          keyword: 'enum',
          params: { allowedValues: schema164.properties.join.enum },
          message: 'must be equal to one of the allowed values',
        };
        if (vErrors === null) {
          vErrors = [err3];
    ...
    if (data.dataSource !== undefined) {
      ...
      if (typeof data3 !== 'string' && data3 !== null) {
        const err6 = {
          ...
          keyword: 'type',
          params: { type: schema163.properties.dataSource.type },
        ...
        if (data0.value !== undefined) {
          if (typeof data0.value !== 'boolean') {
            const err4 = {
              ...
              keyword: 'type',
              params: { type: schema169.properties.value.type },
              message: 'must be boolean',
            };
            if (vErrors === null) {
              vErrors = [err4];
...
const schema171 = { type: 'string', enum: ['desc', 'asc'], title: 'Direction' };
...
function validate212(
  ...
  if (data && typeof data == 'object' && !Array.isArray(data)) {
    ...
    for (const key0 in data) {
      if (!func2.call(schema167.properties, key0)) {
        const err2 = {
          instancePath,
          schemaPath: '#/additionalProperties',
          keyword: 'additionalProperties',
    ...
    if (data.additionalAttributes !== undefined) {
      if (
        !validate213(data.additionalAttributes, {
...
function validate201(
  ...
  if (data && typeof data == 'object' && !Array.isArray(data)) {
    ...
    if (data.introductionPanel === undefined) {
      const err1 = {
        ...
        schemaPath: '#/anyOf/0/required',
        keyword: 'required',
        params: { missingProperty: 'introductionPanel' },
        message: "must have required property '" + 'introductionPanel' + "'",
      };
      if (vErrors === null) {
        vErrors = [err1];
      } else {
      ...
      if (data && typeof data == 'object' && !Array.isArray(data)) {
        ...
        if (data.introductionPanel === undefined) {
          const err7 = {
            ...
            params: { missingProperty: 'introductionPanel' },
            message:
              "must have required property '" + 'introductionPanel' + "'",
          };
          if (vErrors === null) {
            vErrors = [err7];
          } else {
              ...
              if (data && typeof data == 'object' && !Array.isArray(data)) {
                ...
                if (data.type !== undefined) {
                  ...
                  if (
                    !(
                      data6 === 'NameGenerator' ||
                      data6 === 'NameGeneratorQuickAdd' ||
                      data6 === 'NameGeneratorList' ||
                      data6 === 'NameGeneratorAutoComplete' ||
                      data6 === 'Sociogram' ||
                      data6 === 'OrdinalBin' ||
                      data6 === 'CategoricalBin' ||
                      data6 === 'DyadCensus'
                    )
                  ) {
                    const err18 = {
                      ...
                      keyword: 'enum',
                      params: {
                        allowedValues: schema158.anyOf[6].properties.type.enum,
                      },
                      message: 'must be equal to one of the allowed values',
                    };
                    if (vErrors === null) {
  ...
  if (data && typeof data == 'object' && !Array.isArray(data)) {
    ...
    for (const key0 in data) {
      if (!func2.call(schema158.properties, key0)) {
        const err23 = {
          instancePath,
          schemaPath: '#/additionalProperties',
          keyword: 'additionalProperties',
    ...
    if (data.type !== undefined) {
      ...
      if (
        !(
          ...
          data8 === 'EgoForm' ||
          data8 === 'NameGenerator' ||
          data8 === 'NameGeneratorQuickAdd' ||
          data8 === 'NameGeneratorList' ||
          data8 === 'NameGeneratorAutoComplete' ||
          data8 === 'Sociogram' ||
          data8 === 'DyadCensus' ||
          data8 === 'Information' ||
          data8 === 'OrdinalBin' ||
          data8 === 'CategoricalBin'
        )
      ) {
        const err26 = {
          instancePath: instancePath + '/type',
          schemaPath: '#/properties/type/enum',
          keyword: 'enum',
          params: { allowedValues: schema158.properties.type.enum },
          message: 'must be equal to one of the allowed values',
        };
        if (vErrors === null) {
          vErrors = [err26];
    ...
    if (data.quickAdd !== undefined) {
      ...
      if (typeof data11 !== 'string' && data11 !== null) {
        const err28 = {
          ...
          keyword: 'type',
          params: { type: schema158.properties.quickAdd.type },
          message: 'must be string,null',
        };
        if (vErrors === null) {
          vErrors = [err28];
    ...
    if (data.dataSource !== undefined) {
      ...
      if (typeof data13 !== 'string' && data13 !== null) {
        const err30 = {
          ...
          schemaPath: '#/properties/dataSource/type',
          keyword: 'type',
          params: { type: schema158.properties.dataSource.type },
          message: 'must be string,null',
        };
        if (vErrors === null) {
          vErrors = [err30];
            ...
            if (data39.type !== undefined) {
              ...
              if (!(data41 === 'text' || data41 === 'asset')) {
                const err64 = {
                  ...
                  keyword: 'enum',
                  params: { allowedValues: schema184.properties.type.enum },
                  message: 'must be equal to one of the allowed values',
                };
                if (vErrors === null) {
                  vErrors = [err64];
