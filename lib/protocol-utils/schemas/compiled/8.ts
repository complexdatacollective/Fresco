  ...
  definitions: {
    Protocol: {
      ...
      properties: {
        ...
        codebook: { $ref: '#/definitions/codebook' },
        assetManifest: { $ref: '#/definitions/AssetManifest' },
        stages: { type: 'array', items: { $ref: '#/definitions/Stage' } },
      },
      required: ['stages', 'codebook'],
      title: 'Protocol',
    },
    AssetManifest: { type: 'object', title: 'AssetManifest' },
    Form: {
      type: ['object', 'null'],
      additionalProperties: false,
      properties: {
    ...
    Field: {
      type: 'object',
      additionalProperties: false,
      properties: { variable: { type: 'string' }, prompt: { type: 'string' } },
    ...
    Stage: {
      ...
      properties: {
        ...
        quickAdd: { type: ['string', 'null'] },
        createEdge: { type: 'string' },
        ...
        background: {
          ...
          properties: {
            image: { type: 'string' },
            concentricCircles: { type: 'integer' },
            skewedTowardCenter: { type: 'boolean' },
          },
          additionalProperties: false,
          required: ['concentricCircles', 'skewedTowardCenter'],
        },
        sortOptions: { $ref: '#/definitions/SortOptions' },
        cardOptions: {
          type: 'object',
          patternProperties: {
            '^[0-9]{2,6}$': { $ref: '#/definitions/CardOptions' },
          },
        },
        searchOptions: { $ref: '#/definitions/SearchOptions' },
        behaviours: { $ref: '#/definitions/Behaviours' },
        showExistingNodes: { type: 'boolean' },
        title: { type: 'string' },
        items: { type: 'array', items: { $ref: '#/definitions/Item' } },
        introductionPanel: { $ref: '#/definitions/IntroductionPanel' },
        skipLogic: { $ref: '#/definitions/SkipLogic' },
        filter: { $ref: '#/definitions/Filter' },
      },
      required: ['id', 'label', 'type'],
      title: 'Interface',
      anyOf: [
        { properties: { type: { const: 'EgoForm' } }, required: ['form'] },
        {
          properties: { type: { const: 'DyadCensus' } },
          required: ['subject', 'prompts'],
        },
        {
          properties: { type: { const: 'TieStrengthCensus' } },
          required: ['subject', 'prompts'],
        },
        { properties: { type: { const: 'AlterForm' } }, required: ['form'] },
        {
          properties: { type: { const: 'AlterEdgeForm' } },
          required: ['form'],
        },
        { properties: { type: { const: 'Information' } }, required: ['items'] },
        {
          properties: { type: { const: 'Narrative' } },
    ...
    Item: {
      ...
      properties: {
        id: { type: 'string' },
        type: { type: 'string', enum: ['text', 'asset'] },
        content: { type: 'string' },
        description: { type: 'string' },
        size: { type: 'string' },
        loop: { type: 'boolean' },
    ...
    Rule: {
      ...
      additionalProperties: false,
      properties: {
        type: { type: 'string', enum: ['alter', 'ego', 'edge'] },
        id: { type: 'string' },
    ...
    Options: {
      ...
      properties: {
        ...
        value: { type: ['integer', 'string', 'boolean', 'array'] },
      },
      required: ['operator'],
      title: 'Rule Options',
      allOf: [
    ...
    Prompt: {
      ...
      properties: {
        ...
        edgeVariable: { type: 'string' },
        negativeLabel: { type: 'string' },
        otherVariable: { type: 'string' },
        otherVariablePrompt: { type: 'string' },
        otherOptionLabel: { type: 'string' },
        bucketSortOrder: {
          type: 'array',
    ...
    Preset: {
      ...
      properties: {
        id: { type: 'string' },
        label: { type: 'string' },
        layoutVariable: { type: 'string' },
        groupVariable: { type: 'string' },
        edges: { $ref: '#/definitions/Edges' },
        highlight: { $ref: '#/definitions/NarrativeHighlight' },
      },
    ...
    Behaviours: {
      ...
      properties: {
        ...
        freeDraw: { type: 'boolean' },
        featureNode: { type: 'boolean' },
        allowRepositioning: { type: 'boolean' },
        automaticLayout: { $ref: '#/definitions/AutomaticLayout' },
      },
      required: [],
      title: 'Behaviours',
    },
    AdditionalAttributes: {
      ...
      items: { $ref: '#/definitions/AdditionalAttribute' },
    },
    AdditionalAttribute: {
      type: 'object',
      additionalProperties: false,
    ...
    SortOrder: {
      ...
      properties: {
        ...
        type: { enum: ['string', 'number', 'boolean', 'date', 'hierarchy'] },
        hierarchy: {
          type: 'array',
    ...
    Property: {
      type: 'object',
      additionalProperties: false,
      properties: { label: { type: 'string' }, variable: { type: 'string' } },
    ...
    Edges: {
      ...
      properties: {
        ...
        restrict: {
          ...
          properties: {
            origin: { type: 'string' },
            destination: { type: 'string', enum: ['same', 'different', 'all'] },
          },
        },
      },
      required: [],
    ...
    Highlight: {
      ...
      properties: {
        variable: { type: 'string' },
        allowHighlighting: { type: 'boolean' },
      },
    ...
    Layout: {
      ...
      additionalProperties: false,
      properties: {
        layoutVariable: { anyOf: [{ type: 'string' }, { type: 'object' }] },
        allowPositioning: { type: 'boolean' },
      },
    ...
    SearchOptions: {
      ...
      properties: {
        ...
        matchProperties: { type: 'array', items: { type: 'string' } },
      },
    ...
    Edge: {
      ...
      additionalProperties: false,
      title: 'Edge',
      patternProperties: { '.+': { $ref: '#/definitions/EdgeTypeDef' } },
    },
    EdgeTypeDef: {
      type: 'object',
      additionalProperties: false,
    ...
    Variable: {
      ...
      properties: {
        ...
        options: {
          type: 'array',
          items: { $ref: '#/definitions/OptionElement' },
        },
    ...
    Validation: {
      ...
      properties: {
        ...
        requiredAcceptsNull: { type: 'boolean' },
        ...
        sameAs: { type: 'string' },
        greaterThanVariable: { type: 'string' },
        lessThanVariable: { type: 'string' },
      },
      title: 'Validation',
    },
    Node: {
      ...
      additionalProperties: false,
      title: 'Node',
      patternProperties: { '.+': { $ref: '#/definitions/NodeTypeDef' } },
    },
    NodeTypeDef: {
      type: 'object',
      additionalProperties: false,
    ...
    Ego: {
      type: 'object',
      additionalProperties: false,
      properties: { variables: { $ref: '#/definitions/Variables' } },
    },
    OptionElement: {
      anyOf: [
    ...
    Entity: { type: 'string', enum: ['edge', 'node', 'ego'], title: 'Entity' },
...
const schema335 = { type: 'object', title: 'AssetManifest' };
const formats0 = /\d+/;
const schema323 = {
  type: 'object',
  additionalProperties: false,
...
const schema327 = {
  ...
  properties: {
    ...
    options: { type: 'array', items: { $ref: '#/definitions/OptionElement' } },
    parameters: { type: 'object' },
    validation: { $ref: '#/definitions/Validation' },
  },
  required: ['type', 'name'],
  ...
  if (data && typeof data == 'object' && !Array.isArray(data)) {
    ...
    if (data.negative !== undefined) {
      if (typeof data.negative !== 'boolean') {
        const err9 = {
          instancePath: instancePath + '/negative',
    ...
    if (data.type !== undefined) {
      ...
      if (
        ...
        const err6 = {
          ...
          keyword: 'enum',
          params: { allowedValues: schema327.properties.type.enum },
    ...
    if (data.component !== undefined) {
      ...
      if (
        !(
          ...
          data2 === 'TextArea' ||
          data2 === 'Toggle' ||
          data2 === 'ToggleButtonGroup' ||
          data2 === 'Slider' ||
          data2 === 'VisualAnalogScale' ||
          data2 === 'LikertScale' ||
          data2 === 'DatePicker' ||
          data2 === 'RelativeDatePicker'
        )
      ) {
        const err8 = {
          instancePath: instancePath + '/component',
          ...
          keyword: 'enum',
          params: { allowedValues: schema327.properties.component.enum },
          message: 'must be equal to one of the allowed values',
        };
        if (vErrors === null) {
          vErrors = [err8];
        ...
        for (let i0 = 0; i0 < len0; i0++) {
          if (
            ...
            vErrors =
              vErrors === null
                ? validate412.errors
                : vErrors.concat(validate412.errors);
            errors = vErrors.length;
          }
        }
      } else {
    ...
    if (data.validation !== undefined) {
      ...
      if (data6 && typeof data6 == 'object' && !Array.isArray(data6)) {
        for (const key1 in data6) {
          if (!func2.call(schema331.properties, key1)) {
            const err11 = {
        ...
        if (data6.required !== undefined) {
          if (typeof data6.required !== 'boolean') {
            const err12 = {
              instancePath: instancePath + '/validation/required',
        ...
        if (data6.requiredAcceptsNull !== undefined) {
          if (typeof data6.requiredAcceptsNull !== 'boolean') {
            const err13 = {
              instancePath: instancePath + '/validation/requiredAcceptsNull',
              schemaPath:
                '#/definitions/Validation/properties/requiredAcceptsNull/type',
              keyword: 'type',
              params: { type: 'boolean' },
              message: 'must be boolean',
            };
        ...
        if (data6.minLength !== undefined) {
          ...
          if (
            ...
            const err14 = {
              instancePath: instancePath + '/validation/minLength',
        ...
        if (data6.maxLength !== undefined) {
          ...
          if (
            ...
            const err15 = {
              instancePath: instancePath + '/validation/maxLength',
        ...
        if (data6.minValue !== undefined) {
          ...
          if (
            ...
            const err16 = {
              instancePath: instancePath + '/validation/minValue',
        ...
        if (data6.maxValue !== undefined) {
          ...
          if (
            ...
            const err17 = {
              instancePath: instancePath + '/validation/maxValue',
        ...
        if (data6.minSelected !== undefined) {
          ...
          if (
            ...
            const err18 = {
              instancePath: instancePath + '/validation/minSelected',
              schemaPath:
                '#/definitions/Validation/properties/minSelected/type',
              keyword: 'type',
              params: { type: 'integer' },
              message: 'must be integer',
            };
        ...
        if (data6.maxSelected !== undefined) {
          ...
          if (
            ...
            const err19 = {
              instancePath: instancePath + '/validation/maxSelected',
              schemaPath:
                '#/definitions/Validation/properties/maxSelected/type',
              keyword: 'type',
              params: { type: 'integer' },
              message: 'must be integer',
            };
        ...
        if (data6.unique !== undefined) {
          if (typeof data6.unique !== 'boolean') {
            const err20 = {
              instancePath: instancePath + '/validation/unique',
        ...
        if (data6.differentFrom !== undefined) {
          if (typeof data6.differentFrom !== 'string') {
            const err21 = {
              instancePath: instancePath + '/validation/differentFrom',
              schemaPath:
                '#/definitions/Validation/properties/differentFrom/type',
              keyword: 'type',
              params: { type: 'string' },
              message: 'must be string',
            };
        ...
        if (data6.sameAs !== undefined) {
          if (typeof data6.sameAs !== 'string') {
            const err22 = {
              instancePath: instancePath + '/validation/sameAs',
        ...
        if (data6.greaterThanVariable !== undefined) {
          if (typeof data6.greaterThanVariable !== 'string') {
            const err23 = {
              instancePath: instancePath + '/validation/greaterThanVariable',
              schemaPath:
                '#/definitions/Validation/properties/greaterThanVariable/type',
              keyword: 'type',
              params: { type: 'string' },
              message: 'must be string',
            };
        ...
        if (data6.lessThanVariable !== undefined) {
          if (typeof data6.lessThanVariable !== 'string') {
            const err24 = {
              instancePath: instancePath + '/validation/lessThanVariable',
              schemaPath:
                '#/definitions/Validation/properties/lessThanVariable/type',
              keyword: 'type',
              params: { type: 'string' },
              message: 'must be string',
            };
      ...
      if (pattern0.test(key1)) {
        if (
          ...
          vErrors =
            vErrors === null
              ? validate411.errors
              : vErrors.concat(validate411.errors);
          errors = vErrors.length;
        }
      }
    }
  ...
  if (data && typeof data == 'object' && !Array.isArray(data)) {
    ...
    if (data.displayVariable !== undefined) {
      if (typeof data.displayVariable !== 'string') {
        const err4 = {
          instancePath: instancePath + '/displayVariable',
    ...
    if (data.iconVariant !== undefined) {
      if (typeof data.iconVariant !== 'string') {
        const err5 = {
          instancePath: instancePath + '/iconVariant',
...
function validate407(
  ...
  if (data && typeof data == 'object' && !Array.isArray(data)) {
    ...
    if (data.edge !== undefined) {
      if (
        !validate420(data.edge, {
          instancePath: instancePath + '/edge',
          parentData: data,
          parentDataProperty: 'edge',
          rootData,
        })
      ) {
        vErrors =
    ...
    if (data.ego !== undefined) {
      if (
        !validate425(data.ego, {
          instancePath: instancePath + '/ego',
          parentData: data,
          parentDataProperty: 'ego',
          rootData,
        })
      ) {
        vErrors =
...
const schema336 = {
  ...
  anyOf: [
    ...
    { properties: { type: { const: 'AlterForm' } }, required: ['form'] },
    { properties: { type: { const: 'AlterEdgeForm' } }, required: ['form'] },
    { properties: { type: { const: 'Information' } }, required: ['items'] },
    {
      properties: { type: { const: 'Narrative' } },
      required: ['presets', 'background'],
          ...
          if (data2 && typeof data2 == 'object' && !Array.isArray(data2)) {
            if (data2.variable === undefined) {
              const err4 = {
                ...
                keyword: 'required',
                params: { missingProperty: 'variable' },
                message: "must have required property '" + 'variable' + "'",
              };
              if (vErrors === null) {
                vErrors = [err4];
              } else {
            ...
            if (data2.variable !== undefined) {
              if (typeof data2.variable !== 'string') {
                const err7 = {
                  instancePath: instancePath + '/fields/' + i0 + '/variable',
            ...
            if (data2.prompt !== undefined) {
              if (typeof data2.prompt !== 'string') {
                const err8 = {
                  instancePath: instancePath + '/fields/' + i0 + '/prompt',
    ...
    if (data.type !== undefined) {
      ...
      if (!(data0 === 'alter' || data0 === 'ego' || data0 === 'edge')) {
        const err5 = {
          ...
          schemaPath: '#/properties/type/enum',
          keyword: 'enum',
          params: { allowedValues: schema343.properties.type.enum },
          message: 'must be equal to one of the allowed values',
        };
        if (vErrors === null) {
          vErrors = [err5];
        ...
        if (data2.operator !== undefined) {
          ...
          if (
            !(
              ...
              data3 === 'NOT' ||
              data3 === 'GREATER_THAN' ||
              data3 === 'GREATER_THAN_OR_EQUAL' ||
              data3 === 'LESS_THAN' ||
              data3 === 'LESS_THAN_OR_EQUAL' ||
              data3 === 'INCLUDES' ||
              data3 === 'EXCLUDES' ||
              data3 === 'OPTIONS_GREATER_THAN' ||
              data3 === 'OPTIONS_LESS_THAN' ||
              data3 === 'OPTIONS_EQUALS' ||
              data3 === 'OPTIONS_NOT_EQUALS' ||
              data3 === 'CONTAINS' ||
              data3 === 'DOES NOT CONTAIN'
            )
          ) {
            const err7 = {};
            if (vErrors === null) {
      ...
      if (data2 && typeof data2 == 'object' && !Array.isArray(data2)) {
        ...
        if (data2.type !== undefined) {
          if (typeof data2.type !== 'string') {
            const err12 = {
              instancePath: instancePath + '/options/type',
        ...
        if (data2.attribute !== undefined) {
          if (typeof data2.attribute !== 'string') {
            const err13 = {
              instancePath: instancePath + '/options/attribute',
        ...
        if (data2.operator !== undefined) {
          ...
          if (typeof data6 !== 'string') {
            const err14 = {
              instancePath: instancePath + '/options/operator',
          ...
          if (
            !(
              ...
              data6 === 'NOT' ||
              data6 === 'GREATER_THAN' ||
              data6 === 'GREATER_THAN_OR_EQUAL' ||
              data6 === 'LESS_THAN' ||
              data6 === 'LESS_THAN_OR_EQUAL' ||
              data6 === 'INCLUDES' ||
              data6 === 'EXCLUDES' ||
              data6 === 'OPTIONS_GREATER_THAN' ||
              data6 === 'OPTIONS_LESS_THAN' ||
              data6 === 'OPTIONS_EQUALS' ||
              data6 === 'OPTIONS_NOT_EQUALS' ||
              data6 === 'CONTAINS' ||
              data6 === 'DOES NOT CONTAIN'
            )
          ) {
            const err15 = {
              instancePath: instancePath + '/options/operator',
              ...
              keyword: 'enum',
              params: { allowedValues: schema344.properties.operator.enum },
              message: 'must be equal to one of the allowed values',
            };
            if (vErrors === null) {
              vErrors = [err15];
        ...
        if (data2.value !== undefined) {
          ...
          if (
            ...
            const err16 = {
              instancePath: instancePath + '/options/value',
              schemaPath: '#/definitions/Options/properties/value/type',
              keyword: 'type',
              params: { type: schema344.properties.value.type },
              message: 'must be integer,string,boolean,array',
            };
            if (vErrors === null) {
              vErrors = [err16];
            } else {
    ...
    if (data.join !== undefined) {
      ...
      if (!(data0 === 'OR' || data0 === 'AND')) {
        const err3 = {
          ...
          keyword: 'enum',
          params: { allowedValues: schema342.properties.join.enum },
          message: 'must be equal to one of the allowed values',
        };
        if (vErrors === null) {
          vErrors = [err3];
  ...
  if (data && typeof data == 'object' && !Array.isArray(data)) {
    ...
    if (data.dataSource === undefined) {
      const err2 = {
        ...
        schemaPath: '#/required',
        keyword: 'required',
        params: { missingProperty: 'dataSource' },
        message: "must have required property '" + 'dataSource' + "'",
      };
      if (vErrors === null) {
        vErrors = [err2];
      } else {
    ...
    if (data.filter !== undefined) {
      if (
        ...
        vErrors =
          vErrors === null
            ? validate436.errors
            : vErrors.concat(validate436.errors);
        errors = vErrors.length;
      }
    }
    if (data.dataSource !== undefined) {
      ...
      if (typeof data3 !== 'string' && data3 !== null) {
        const err6 = {
          ...
          keyword: 'type',
          params: { type: schema341.properties.dataSource.type },
...
const schema345 = {
  ...
  properties: {
    ...
    binSortOrder: { type: 'array', items: { $ref: '#/definitions/SortOrder' } },
    sortOrder: { type: 'array', items: { $ref: '#/definitions/SortOrder' } },
    color: { type: 'string' },
    layout: { $ref: '#/definitions/Layout' },
    edges: { $ref: '#/definitions/Edges' },
    highlight: { $ref: '#/definitions/Highlight' },
...
const schema347 = {
  type: 'object',
  additionalProperties: false,
  properties: { variable: { type: 'string' }, value: { type: ['boolean'] } },
  required: ['variable', 'value'],
  title: 'AdditionalAttribute',
};
      ...
      if (data0 && typeof data0 == 'object' && !Array.isArray(data0)) {
        ...
        for (const key0 in data0) {
          if (!(key0 === 'variable' || key0 === 'value')) {
            const err2 = {
              instancePath: instancePath + '/' + i0,
              schemaPath:
                '#/definitions/AdditionalAttribute/additionalProperties',
              keyword: 'additionalProperties',
              params: { additionalProperty: key0 },
              message: 'must NOT have additional properties',
            };
        ...
        if (data0.variable !== undefined) {
          if (typeof data0.variable !== 'string') {
            const err3 = {
              instancePath: instancePath + '/' + i0 + '/variable',
              schemaPath:
                '#/definitions/AdditionalAttribute/properties/variable/type',
              keyword: 'type',
              params: { type: 'string' },
              message: 'must be string',
            };
        ...
        if (data0.value !== undefined) {
          if (typeof data0.value !== 'boolean') {
            const err4 = {
              instancePath: instancePath + '/' + i0 + '/value',
              schemaPath:
                '#/definitions/AdditionalAttribute/properties/value/type',
              keyword: 'type',
              params: { type: schema347.properties.value.type },
              message: 'must be boolean',
            };
            if (vErrors === null) {
              vErrors = [err4];
...
const schema349 = { type: 'string', enum: ['desc', 'asc'], title: 'Direction' };
    ...
    if (data.direction !== undefined) {
      ...
      if (!(data1 === 'desc' || data1 === 'asc')) {
        const err4 = {
          ...
          keyword: 'enum',
          params: { allowedValues: schema349.enum },
          message: 'must be equal to one of the allowed values',
        };
        if (vErrors === null) {
          vErrors = [err4];
    ...
    if (data.type !== undefined) {
      ...
      if (
        ...
        const err5 = {
          ...
          schemaPath: '#/properties/type/enum',
          keyword: 'enum',
          params: { allowedValues: schema348.properties.type.enum },
          message: 'must be equal to one of the allowed values',
        };
        if (vErrors === null) {
          vErrors = [err5];
      ...
      if (Array.isArray(data3)) {
        ...
        for (let i0 = 0; i0 < len0; i0++) {
          ...
          if (
            ...
            const err6 = {
              instancePath: instancePath + '/hierarchy/' + i0,
              schemaPath: '#/properties/hierarchy/items/type',
              keyword: 'type',
              params: { type: schema348.properties.hierarchy.items.type },
        ...
        const err7 = {
          instancePath: instancePath + '/hierarchy',
...
function validate441(
  ...
  if (data && typeof data == 'object' && !Array.isArray(data)) {
    ...
    if (data.additionalAttributes !== undefined) {
      if (
        !validate442(data.additionalAttributes, {
          instancePath: instancePath + '/additionalAttributes',
          parentData: data,
          parentDataProperty: 'additionalAttributes',
          rootData,
        })
      ) {
        vErrors =
    ...
    if (data.edgeVariable !== undefined) {
      if (typeof data.edgeVariable !== 'string') {
        const err6 = {
          instancePath: instancePath + '/edgeVariable',
    ...
    if (data.negativeLabel !== undefined) {
      if (typeof data.negativeLabel !== 'string') {
        const err7 = {
          instancePath: instancePath + '/negativeLabel',
    ...
    if (data.otherVariable !== undefined) {
      if (typeof data.otherVariable !== 'string') {
        const err8 = {
          instancePath: instancePath + '/otherVariable',
    ...
    if (data.otherVariablePrompt !== undefined) {
      if (typeof data.otherVariablePrompt !== 'string') {
        const err9 = {
          instancePath: instancePath + '/otherVariablePrompt',
    ...
    if (data.otherOptionLabel !== undefined) {
      if (typeof data.otherOptionLabel !== 'string') {
        const err10 = {
          instancePath: instancePath + '/otherOptionLabel',
    ...
    if (data.bucketSortOrder !== undefined) {
      ...
      if (Array.isArray(data9)) {
        ...
        for (let i0 = 0; i0 < len0; i0++) {
          if (
            !validate444(data9[i0], {
              instancePath: instancePath + '/bucketSortOrder/' + i0,
              parentData: data9,
              parentDataProperty: i0,
              rootData,
            })
        ...
        const err11 = {
          instancePath: instancePath + '/bucketSortOrder',
    ...
    if (data.binSortOrder !== undefined) {
      ...
      if (Array.isArray(data11)) {
        ...
        for (let i1 = 0; i1 < len1; i1++) {
          if (
            !validate444(data11[i1], {
              instancePath: instancePath + '/binSortOrder/' + i1,
              parentData: data11,
        ...
        const err12 = {
          instancePath: instancePath + '/binSortOrder',
    ...
    if (data.sortOrder !== undefined) {
      ...
      if (Array.isArray(data13)) {
        ...
        for (let i2 = 0; i2 < len2; i2++) {
          if (
            !validate444(data13[i2], {
              instancePath: instancePath + '/sortOrder/' + i2,
              parentData: data13,
        ...
        const err13 = {
          instancePath: instancePath + '/sortOrder',
      ...
      if (data16 && typeof data16 == 'object' && !Array.isArray(data16)) {
        if (data16.layoutVariable === undefined) {
          const err15 = {
            ...
            keyword: 'required',
            params: { missingProperty: 'layoutVariable' },
            message: "must have required property '" + 'layoutVariable' + "'",
          };
          if (vErrors === null) {
            vErrors = [err15];
          } else {
        ...
        if (data16.layoutVariable !== undefined) {
          ...
          if (typeof data17 !== 'string') {
            const err17 = {
              instancePath: instancePath + '/layout/layoutVariable',
              schemaPath:
                '#/definitions/Layout/properties/layoutVariable/anyOf/0/type',
              keyword: 'type',
              params: { type: 'string' },
              message: 'must be string',
            };
          ...
          if (!valid9) {
            ...
            if (
              !(data17 && typeof data17 == 'object' && !Array.isArray(data17))
            ) {
              const err18 = {
                instancePath: instancePath + '/layout/layoutVariable',
                schemaPath:
                  '#/definitions/Layout/properties/layoutVariable/anyOf/1/type',
                keyword: 'type',
                params: { type: 'object' },
                message: 'must be object',
              };
          ...
          if (!valid9) {
            const err19 = {
              instancePath: instancePath + '/layout/layoutVariable',
              schemaPath:
                '#/definitions/Layout/properties/layoutVariable/anyOf',
              keyword: 'anyOf',
              params: {},
              message: 'must match a schema in anyOf',
            };
        ...
        if (data16.allowPositioning !== undefined) {
          if (typeof data16.allowPositioning !== 'boolean') {
            const err20 = {
              instancePath: instancePath + '/layout/allowPositioning',
              schemaPath:
                '#/definitions/Layout/properties/allowPositioning/type',
              keyword: 'type',
              params: { type: 'boolean' },
              message: 'must be boolean',
            };
    ...
    if (data.edges !== undefined) {
      ...
      if (data19 && typeof data19 == 'object' && !Array.isArray(data19)) {
        for (const key2 in data19) {
          if (
            !(key2 === 'display' || key2 === 'create' || key2 === 'restrict')
          ) {
            const err22 = {
          ...
          if (Array.isArray(data20)) {
            ...
            for (let i3 = 0; i3 < len3; i3++) {
              if (typeof data20[i3] !== 'string') {
                const err23 = {
                  instancePath: instancePath + '/edges/display/' + i3,
                  schemaPath:
                    '#/definitions/Edges/properties/display/items/type',
                  keyword: 'type',
                  params: { type: 'string' },
                  message: 'must be string',
                };
            ...
            const err24 = {
              instancePath: instancePath + '/edges/display',
        ...
        if (data19.create !== undefined) {
          if (typeof data19.create !== 'string') {
            const err25 = {
              instancePath: instancePath + '/edges/create',
          ...
          if (data23 && typeof data23 == 'object' && !Array.isArray(data23)) {
            if (data23.origin !== undefined) {
              if (typeof data23.origin !== 'string') {
                const err26 = {
                  instancePath: instancePath + '/edges/restrict/origin',
                  schemaPath:
                    '#/definitions/Edges/properties/restrict/properties/origin/type',
                  keyword: 'type',
                  params: { type: 'string' },
                  message: 'must be string',
                };
            ...
            if (data23.destination !== undefined) {
              ...
              if (typeof data25 !== 'string') {
                const err27 = {
                  instancePath: instancePath + '/edges/restrict/destination',
                  schemaPath:
                    '#/definitions/Edges/properties/restrict/properties/destination/type',
                  keyword: 'type',
                  params: { type: 'string' },
                  message: 'must be string',
                };
              ...
              if (
                ...
                const err28 = {
                  instancePath: instancePath + '/edges/restrict/destination',
                  schemaPath:
                    '#/definitions/Edges/properties/restrict/properties/destination/enum',
                  keyword: 'enum',
                  params: {
                    allowedValues:
                      schema351.properties.restrict.properties.destination.enum,
                  },
                  message: 'must be equal to one of the allowed values',
                };
                if (vErrors === null) {
            ...
            const err29 = {
              instancePath: instancePath + '/edges/restrict',
      ...
      if (data26 && typeof data26 == 'object' && !Array.isArray(data26)) {
        if (data26.allowHighlighting === undefined) {
          const err31 = {
            ...
            keyword: 'required',
            params: { missingProperty: 'allowHighlighting' },
            message:
              "must have required property '" + 'allowHighlighting' + "'",
          };
          if (vErrors === null) {
            vErrors = [err31];
          } else {
        ...
        if (data26.variable !== undefined) {
          if (typeof data26.variable !== 'string') {
            const err33 = {
              instancePath: instancePath + '/highlight/variable',
        ...
        if (data26.allowHighlighting !== undefined) {
          if (typeof data26.allowHighlighting !== 'boolean') {
            const err34 = {
              instancePath: instancePath + '/highlight/allowHighlighting',
              schemaPath:
                '#/definitions/Highlight/properties/allowHighlighting/type',
              keyword: 'type',
              params: { type: 'boolean' },
              message: 'must be boolean',
            };
    ...
    if (data.createEdge !== undefined) {
      if (typeof data.createEdge !== 'string') {
        const err36 = {
          instancePath: instancePath + '/createEdge',
  ...
  if (data && typeof data == 'object' && !Array.isArray(data)) {
    ...
    if (data.layoutVariable !== undefined) {
      if (typeof data.layoutVariable !== 'string') {
        const err6 = {
          instancePath: instancePath + '/layoutVariable',
    ...
    if (data.groupVariable !== undefined) {
      if (typeof data.groupVariable !== 'string') {
        const err7 = {
          instancePath: instancePath + '/groupVariable',
    ...
    if (data.edges !== undefined) {
      ...
      if (data4 && typeof data4 == 'object' && !Array.isArray(data4)) {
        for (const key1 in data4) {
          if (
            !(key1 === 'display' || key1 === 'create' || key1 === 'restrict')
          ) {
            const err8 = {
              instancePath: instancePath + '/edges',
              schemaPath: '#/definitions/Edges/additionalProperties',
          ...
          if (Array.isArray(data5)) {
            ...
            for (let i0 = 0; i0 < len0; i0++) {
              if (typeof data5[i0] !== 'string') {
                const err9 = {
                  instancePath: instancePath + '/edges/display/' + i0,
                  schemaPath:
                    '#/definitions/Edges/properties/display/items/type',
                  keyword: 'type',
                  params: { type: 'string' },
      ...
      if (Array.isArray(data11)) {
        ...
        for (let i1 = 0; i1 < len1; i1++) {
          if (typeof data11[i1] !== 'string') {
            const err17 = {
              instancePath: instancePath + '/highlight/' + i1,
  ...
  if (data && typeof data == 'object' && !Array.isArray(data)) {
    if (data.sortOrder === undefined) {
      const err0 = {
        ...
        schemaPath: '#/required',
        keyword: 'required',
        params: { missingProperty: 'sortOrder' },
    ...
    if (data.sortableProperties === undefined) {
      const err1 = {
        ...
        schemaPath: '#/required',
        keyword: 'required',
        params: { missingProperty: 'sortableProperties' },
        message: "must have required property '" + 'sortableProperties' + "'",
      };
      if (vErrors === null) {
        vErrors = [err1];
      } else {
    ...
    if (data.sortOrder !== undefined) {
      ...
      if (Array.isArray(data0)) {
        ...
        for (let i0 = 0; i0 < len0; i0++) {
          if (
            !validate444(data0[i0], {
              instancePath: instancePath + '/sortOrder/' + i0,
              parentData: data0,
              parentDataProperty: i0,
              rootData,
            })
    ...
    if (data.sortableProperties !== undefined) {
      ...
      if (Array.isArray(data2)) {
        ...
        for (let i1 = 0; i1 < len1; i1++) {
          ...
          if (data3 && typeof data3 == 'object' && !Array.isArray(data3)) {
            if (data3.label === undefined) {
              const err4 = {
                instancePath: instancePath + '/sortableProperties/' + i1,
            ...
            if (data3.label !== undefined) {
              if (typeof data3.label !== 'string') {
                const err7 = {
                  instancePath:
                    instancePath + '/sortableProperties/' + i1 + '/label',
            ...
            if (data3.variable !== undefined) {
              if (typeof data3.variable !== 'string') {
                const err8 = {
                  instancePath:
                    instancePath + '/sortableProperties/' + i1 + '/variable',
        ...
        const err10 = {
          instancePath: instancePath + '/sortableProperties',
  ...
  if (data && typeof data == 'object' && !Array.isArray(data)) {
    if (data.displayLabel === undefined) {
      const err0 = {
        ...
        schemaPath: '#/required',
        keyword: 'required',
        params: { missingProperty: 'displayLabel' },
        message: "must have required property '" + 'displayLabel' + "'",
      };
      if (vErrors === null) {
        vErrors = [err0];
      } else {
    ...
    if (data.displayLabel !== undefined) {
      if (typeof data.displayLabel !== 'string') {
        const err2 = {
          instancePath: instancePath + '/displayLabel',
        ...
        for (let i0 = 0; i0 < len0; i0++) {
          ...
          if (data2 && typeof data2 == 'object' && !Array.isArray(data2)) {
            if (data2.label === undefined) {
              const err3 = {
                instancePath: instancePath + '/additionalProperties/' + i0,
                schemaPath: '#/definitions/Property/required',
                keyword: 'required',
                params: { missingProperty: 'label' },
                message: "must have required property '" + 'label' + "'",
            ...
            if (data2.label !== undefined) {
              if (typeof data2.label !== 'string') {
                const err6 = {
                  instancePath:
                    instancePath + '/additionalProperties/' + i0 + '/label',
                  schemaPath: '#/definitions/Property/properties/label/type',
                  keyword: 'type',
                  params: { type: 'string' },
                  message: 'must be string',
            ...
            if (data2.variable !== undefined) {
              if (typeof data2.variable !== 'string') {
                const err7 = {
                  instancePath:
                    instancePath + '/additionalProperties/' + i0 + '/variable',
                  schemaPath: '#/definitions/Property/properties/variable/type',
                  keyword: 'type',
                  params: { type: 'string' },
                  message: 'must be string',
  ...
  if (data && typeof data == 'object' && !Array.isArray(data)) {
    ...
    if (data.freeDraw !== undefined) {
      if (typeof data.freeDraw !== 'boolean') {
        const err2 = {
          instancePath: instancePath + '/freeDraw',
    ...
    if (data.featureNode !== undefined) {
      if (typeof data.featureNode !== 'boolean') {
        const err3 = {
          instancePath: instancePath + '/featureNode',
    ...
    if (data.allowRepositioning !== undefined) {
      if (typeof data.allowRepositioning !== 'boolean') {
        const err4 = {
          instancePath: instancePath + '/allowRepositioning',
    ...
    if (data.automaticLayout !== undefined) {
      ...
      if (data5 && typeof data5 == 'object' && !Array.isArray(data5)) {
        if (data5.enabled === undefined) {
          const err5 = {
            instancePath: instancePath + '/automaticLayout',
        ...
        if (data5.enabled !== undefined) {
          if (typeof data5.enabled !== 'boolean') {
            const err7 = {
              instancePath: instancePath + '/automaticLayout/enabled',
              schemaPath:
                '#/definitions/AutomaticLayout/properties/enabled/type',
              keyword: 'type',
              params: { type: 'boolean' },
              message: 'must be boolean',
            };
    ...
    if (data.action !== undefined) {
      ...
      if (!(data0 === 'SHOW' || data0 === 'SKIP')) {
        const err4 = {
          ...
          keyword: 'enum',
          params: { allowedValues: schema365.properties.action.enum },
          message: 'must be equal to one of the allowed values',
        };
        if (vErrors === null) {
          vErrors = [err4];
...
function validate429(
  ...
  if (data && typeof data == 'object' && !Array.isArray(data)) {
    if (data.form === undefined) {
      const err0 = {
        ...
        message: "must have required property '" + 'form' + "'",
      };
      if (vErrors === null) {
        vErrors = [err0];
      } else {
      ...
      if (data.type !== undefined) {
        if ('DyadCensus' !== data.type) {
          const err4 = {
            ...
            keyword: 'const',
            params: { allowedValue: 'DyadCensus' },
            message: 'must be equal to constant',
          };
          if (vErrors === null) {
            vErrors = [err4];
        ...
        if (data.type !== undefined) {
          if ('TieStrengthCensus' !== data.type) {
            const err7 = {
              ...
              keyword: 'const',
              params: { allowedValue: 'TieStrengthCensus' },
              message: 'must be equal to constant',
            };
            if (vErrors === null) {
              vErrors = [err7];
            ...
            if (data.type !== undefined) {
              if ('AlterEdgeForm' !== data.type) {
                const err11 = {
                  ...
                  keyword: 'const',
                  params: { allowedValue: 'AlterEdgeForm' },
                  message: 'must be equal to constant',
                };
                if (vErrors === null) {
                  vErrors = [err11];
              ...
              if (data.type !== undefined) {
                if ('Information' !== data.type) {
                  const err13 = {
                    ...
                    keyword: 'const',
                    params: { allowedValue: 'Information' },
                    message: 'must be equal to constant',
                  };
                  if (vErrors === null) {
                    vErrors = [err13];
              ...
              if (data && typeof data == 'object' && !Array.isArray(data)) {
                if (data.presets === undefined) {
                  const err14 = {
                    ...
                    keyword: 'required',
                    params: { missingProperty: 'presets' },
                    message: "must have required property '" + 'presets' + "'",
                  };
                  if (vErrors === null) {
                    vErrors = [err14];
                  } else {
                ...
                if (data.background === undefined) {
                  const err15 = {
                    ...
                    message:
                      "must have required property '" + 'background' + "'",
                  };
                  if (vErrors === null) {
                    vErrors = [err15];
                  } else {
                ...
                if (data && typeof data == 'object' && !Array.isArray(data)) {
                  if (data.prompts === undefined) {
                    const err17 = {
                      ...
                      params: { missingProperty: 'prompts' },
                      message:
                        "must have required property '" + 'prompts' + "'",
                    };
                    if (vErrors === null) {
                      vErrors = [err17];
                    } else {
                  ...
                  if (data.type !== undefined) {
                    ...
                    if (
                      !(
                        data7 === 'NameGenerator' ||
                        data7 === 'NameGeneratorQuickAdd' ||
                        data7 === 'NameGeneratorRoster' ||
                        data7 === 'Sociogram' ||
                        data7 === 'OrdinalBin' ||
                        data7 === 'CategoricalBin' ||
                        data7 === 'DyadCensus'
                      )
                    ) {
                      const err18 = {
                        ...
                        params: {
                          allowedValues:
                            schema336.anyOf[7].properties.type.enum,
                        },
                        message: 'must be equal to one of the allowed values',
                      };
                      if (vErrors === null) {
  ...
  if (data && typeof data == 'object' && !Array.isArray(data)) {
    ...
    for (const key0 in data) {
      if (!func2.call(schema336.properties, key0)) {
        const err23 = {
          instancePath,
          schemaPath: '#/additionalProperties',
          keyword: 'additionalProperties',
    ...
    if (data.interviewScript !== undefined) {
      if (typeof data.interviewScript !== 'string') {
        const err25 = {
          instancePath: instancePath + '/interviewScript',
    ...
    if (data.type !== undefined) {
      ...
      if (
        !(
          data10 === 'Narrative' ||
          data10 === 'AlterForm' ||
          data10 === 'AlterEdgeForm' ||
          data10 === 'EgoForm' ||
          data10 === 'NameGenerator' ||
          data10 === 'NameGeneratorQuickAdd' ||
          data10 === 'NameGeneratorRoster' ||
          data10 === 'Sociogram' ||
          data10 === 'DyadCensus' ||
          data10 === 'TieStrengthCensus' ||
          data10 === 'Information' ||
          data10 === 'OrdinalBin' ||
          data10 === 'CategoricalBin'
        )
      ) {
        const err27 = {
          instancePath: instancePath + '/type',
          schemaPath: '#/properties/type/enum',
          keyword: 'enum',
          params: { allowedValues: schema336.properties.type.enum },
          message: 'must be equal to one of the allowed values',
        };
        if (vErrors === null) {
          vErrors = [err27];
    ...
    if (data.form !== undefined) {
      if (
        !validate430(data.form, {
          instancePath: instancePath + '/form',
          parentData: data,
          parentDataProperty: 'form',
          rootData,
        })
      ) {
        vErrors =
          vErrors === null
            ? validate430.errors
            : vErrors.concat(validate430.errors);
        errors = vErrors.length;
      }
    }
    if (data.quickAdd !== undefined) {
      ...
      if (typeof data13 !== 'string' && data13 !== null) {
        const err29 = {
          instancePath: instancePath + '/quickAdd',
          schemaPath: '#/properties/quickAdd/type',
          keyword: 'type',
          params: { type: schema336.properties.quickAdd.type },
          message: 'must be string,null',
        };
        if (vErrors === null) {
          vErrors = [err29];
    ...
    if (data.dataSource !== undefined) {
      ...
      if (typeof data15 !== 'string' && data15 !== null) {
        const err31 = {
          ...
          schemaPath: '#/properties/dataSource/type',
          keyword: 'type',
          params: { type: schema336.properties.dataSource.type },
          message: 'must be string,null',
        };
        if (vErrors === null) {
          vErrors = [err31];
    ...
    if (data.subject !== undefined) {
      ...
      if (!valid10) {
        ...
        if (Array.isArray(data16)) {
          ...
          for (let i0 = 0; i0 < len0; i0++) {
            if (
              !validate432(data16[i0], {
                instancePath: instancePath + '/subject/' + i0,
                parentData: data16,
                parentDataProperty: i0,
                rootData,
              })
    ...
    if (data.panels !== undefined) {
      ...
      if (Array.isArray(data18)) {
        ...
        for (let i1 = 0; i1 < len1; i1++) {
          if (
            !validate435(data18[i1], {
              instancePath: instancePath + '/panels/' + i1,
              parentData: data18,
              parentDataProperty: i1,
              rootData,
            })
        ...
        const err36 = {
          instancePath: instancePath + '/panels',
    ...
    if (data.prompts !== undefined) {
      ...
      if (Array.isArray(data20)) {
        ...
        for (let i2 = 0; i2 < len2; i2++) {
          if (
            !validate441(data20[i2], {
              instancePath: instancePath + '/prompts/' + i2,
              parentData: data20,
              parentDataProperty: i2,
              rootData,
            })
    ...
    if (data.presets !== undefined) {
      ...
      if (Array.isArray(data22)) {
        if (data22.length < 1) {
          const err39 = {
            instancePath: instancePath + '/presets',
        ...
        for (let i3 = 0; i3 < len3; i3++) {
          if (
            !validate449(data22[i3], {
              instancePath: instancePath + '/presets/' + i3,
              parentData: data22,
      ...
      if (data24 && typeof data24 == 'object' && !Array.isArray(data24)) {
        if (data24.concentricCircles === undefined) {
          const err41 = {
            ...
            keyword: 'required',
            params: { missingProperty: 'concentricCircles' },
            message:
              "must have required property '" + 'concentricCircles' + "'",
          };
          if (vErrors === null) {
            vErrors = [err41];
          } else {
        ...
        if (data24.skewedTowardCenter === undefined) {
          const err42 = {
            ...
            schemaPath: '#/properties/background/required',
            keyword: 'required',
            params: { missingProperty: 'skewedTowardCenter' },
            message:
              "must have required property '" + 'skewedTowardCenter' + "'",
          };
          if (vErrors === null) {
            vErrors = [err42];
          } else {
        ...
        for (const key1 in data24) {
          if (
            !(
              key1 === 'image' ||
              key1 === 'concentricCircles' ||
              key1 === 'skewedTowardCenter'
            )
          ) {
            const err43 = {
              instancePath: instancePath + '/background',
              schemaPath: '#/properties/background/additionalProperties',
              keyword: 'additionalProperties',
              params: { additionalProperty: key1 },
              message: 'must NOT have additional properties',
            };
        ...
        if (data24.image !== undefined) {
          if (typeof data24.image !== 'string') {
            const err44 = {
              instancePath: instancePath + '/background/image',
              schemaPath: '#/properties/background/properties/image/type',
              keyword: 'type',
              params: { type: 'string' },
              message: 'must be string',
            };
        ...
        if (data24.concentricCircles !== undefined) {
          ...
          if (
            ...
            const err45 = {
              instancePath: instancePath + '/background/concentricCircles',
              schemaPath:
                '#/properties/background/properties/concentricCircles/type',
              keyword: 'type',
              params: { type: 'integer' },
              message: 'must be integer',
            };
        ...
        if (data24.skewedTowardCenter !== undefined) {
          if (typeof data24.skewedTowardCenter !== 'boolean') {
            const err46 = {
              instancePath: instancePath + '/background/skewedTowardCenter',
              schemaPath:
                '#/properties/background/properties/skewedTowardCenter/type',
              keyword: 'type',
              params: { type: 'boolean' },
              message: 'must be boolean',
            };
    ...
    if (data.sortOptions !== undefined) {
      if (
        !validate451(data.sortOptions, {
          instancePath: instancePath + '/sortOptions',
          parentData: data,
          parentDataProperty: 'sortOptions',
          rootData,
        })
      ) {
        vErrors =
          vErrors === null
            ? validate451.errors
            : vErrors.concat(validate451.errors);
        errors = vErrors.length;
      }
    }
    if (data.cardOptions !== undefined) {
      ...
      if (data29 && typeof data29 == 'object' && !Array.isArray(data29)) {
          ...
          if (pattern6.test(key2)) {
            if (
              ...
              vErrors =
                vErrors === null
                  ? validate454.errors
                  : vErrors.concat(validate454.errors);
              errors = vErrors.length;
            }
          }
        }
        ...
        const err48 = {
          instancePath: instancePath + '/cardOptions',
    ...
    if (data.searchOptions !== undefined) {
      let data31 = data.searchOptions;
      if (data31 && typeof data31 == 'object' && !Array.isArray(data31)) {
        if (data31.fuzziness === undefined) {
          const err49 = {
            instancePath: instancePath + '/searchOptions',
            schemaPath: '#/definitions/SearchOptions/required',
            keyword: 'required',
            params: { missingProperty: 'fuzziness' },
            message: "must have required property '" + 'fuzziness' + "'",
          };
          if (vErrors === null) {
            vErrors = [err49];
          } else {
        ...
        if (data31.matchProperties === undefined) {
          const err50 = {
            instancePath: instancePath + '/searchOptions',
            schemaPath: '#/definitions/SearchOptions/required',
            keyword: 'required',
            params: { missingProperty: 'matchProperties' },
            message: "must have required property '" + 'matchProperties' + "'",
          };
          if (vErrors === null) {
            vErrors = [err50];
          } else {
        ...
        if (data31.fuzziness !== undefined) {
          let data32 = data31.fuzziness;
          if (!(typeof data32 == 'number' && isFinite(data32))) {
            const err52 = {
              instancePath: instancePath + '/searchOptions/fuzziness',
              schemaPath:
                '#/definitions/SearchOptions/properties/fuzziness/type',
              keyword: 'type',
              params: { type: 'number' },
        ...
        if (data31.matchProperties !== undefined) {
          let data33 = data31.matchProperties;
          if (Array.isArray(data33)) {
            ...
            for (let i4 = 0; i4 < len4; i4++) {
              if (typeof data33[i4] !== 'string') {
                const err53 = {
                  instancePath:
                    instancePath + '/searchOptions/matchProperties/' + i4,
                  schemaPath:
                    '#/definitions/SearchOptions/properties/matchProperties/items/type',
                  keyword: 'type',
                  params: { type: 'string' },
                  message: 'must be string',
                };
            ...
            const err54 = {
              instancePath: instancePath + '/searchOptions/matchProperties',
              schemaPath:
                '#/definitions/SearchOptions/properties/matchProperties/type',
              keyword: 'type',
              params: { type: 'array' },
              message: 'must be array',
            };
    ...
    if (data.behaviours !== undefined) {
      if (
        !validate456(data.behaviours, {
          instancePath: instancePath + '/behaviours',
          parentData: data,
          parentDataProperty: 'behaviours',
          rootData,
        })
      ) {
        vErrors =
          vErrors === null
            ? validate456.errors
            : vErrors.concat(validate456.errors);
        errors = vErrors.length;
      }
    }
    if (data.showExistingNodes !== undefined) {
      if (typeof data.showExistingNodes !== 'boolean') {
        const err56 = {
          instancePath: instancePath + '/showExistingNodes',
        ...
        for (let i5 = 0; i5 < len5; i5++) {
          ...
          if (data39 && typeof data39 == 'object' && !Array.isArray(data39)) {
            if (data39.content === undefined) {
              const err58 = {
                instancePath: instancePath + '/items/' + i5,
            ...
            if (data39.id !== undefined) {
              if (typeof data39.id !== 'string') {
                const err62 = {
                  instancePath: instancePath + '/items/' + i5 + '/id',
            ...
            if (data39.type !== undefined) {
              ...
              if (typeof data41 !== 'string') {
                const err63 = {
                  instancePath: instancePath + '/items/' + i5 + '/type',
              ...
              if (!(data41 === 'text' || data41 === 'asset')) {
                const err64 = {
                  ...
                  keyword: 'enum',
                  params: { allowedValues: schema363.properties.type.enum },
                  message: 'must be equal to one of the allowed values',
                };
                if (vErrors === null) {
                  vErrors = [err64];
            ...
            if (data39.content !== undefined) {
              if (typeof data39.content !== 'string') {
                const err65 = {
                  instancePath: instancePath + '/items/' + i5 + '/content',
            ...
            if (data39.description !== undefined) {
              if (typeof data39.description !== 'string') {
                const err66 = {
                  instancePath: instancePath + '/items/' + i5 + '/description',
            ...
            if (data39.size !== undefined) {
              if (typeof data39.size !== 'string') {
                const err67 = {
                  instancePath: instancePath + '/items/' + i5 + '/size',
            ...
            if (data39.loop !== undefined) {
              if (typeof data39.loop !== 'boolean') {
                const err68 = {
                  instancePath: instancePath + '/items/' + i5 + '/loop',
    ...
    if (data.introductionPanel !== undefined) {
      ...
      if (data46 && typeof data46 == 'object' && !Array.isArray(data46)) {
        if (data46.title === undefined) {
          const err71 = {
            instancePath: instancePath + '/introductionPanel',
        ...
        for (const key5 in data46) {
          if (!(key5 === 'title' || key5 === 'text')) {
            const err73 = {
              instancePath: instancePath + '/introductionPanel',
              schemaPath:
                '#/definitions/IntroductionPanel/additionalProperties',
              keyword: 'additionalProperties',
        ...
        if (data46.title !== undefined) {
          if (typeof data46.title !== 'string') {
            const err74 = {
              instancePath: instancePath + '/introductionPanel/title',
              schemaPath:
                '#/definitions/IntroductionPanel/properties/title/type',
              keyword: 'type',
              params: { type: 'string' },
              message: 'must be string',
            };
        ...
        if (data46.text !== undefined) {
          if (typeof data46.text !== 'string') {
            const err75 = {
              instancePath: instancePath + '/introductionPanel/text',
              schemaPath:
                '#/definitions/IntroductionPanel/properties/text/type',
              keyword: 'type',
              params: { type: 'string' },
              message: 'must be string',
            };
    ...
    if (data.skipLogic !== undefined) {
      if (
        !validate458(data.skipLogic, {
          instancePath: instancePath + '/skipLogic',
          parentData: data,
          parentDataProperty: 'skipLogic',
          rootData,
        })
      ) {
        vErrors =
          vErrors === null
            ? validate458.errors
            : vErrors.concat(validate458.errors);
        errors = vErrors.length;
      }
    }
    if (data.filter !== undefined) {
  ...
  if (data && typeof data == 'object' && !Array.isArray(data)) {
    ...
    if (data.codebook === undefined) {
      const err1 = {
        ...
        schemaPath: '#/required',
        keyword: 'required',
        params: { missingProperty: 'codebook' },
        message: "must have required property '" + 'codebook' + "'",
      };
      if (vErrors === null) {
        vErrors = [err1];
      } else {
    ...
    if (data.codebook !== undefined) {
      if (
        !validate407(data.codebook, {
          instancePath: instancePath + '/codebook',
          parentData: data,
          parentDataProperty: 'codebook',
          rootData,
        })
      ) {
        vErrors =
          vErrors === null
            ? validate407.errors
            : vErrors.concat(validate407.errors);
        errors = vErrors.length;
      }
    }
    if (data.assetManifest !== undefined) {
      ...
      if (!(data5 && typeof data5 == 'object' && !Array.isArray(data5))) {
        const err8 = {
          instancePath: instancePath + '/assetManifest',
