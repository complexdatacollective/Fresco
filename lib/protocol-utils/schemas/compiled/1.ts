    ...
    if (data.component !== undefined) {
      ...
      if (
        ...
        const err7 = {
          ...
          keyword: 'enum',
          params: { allowedValues: schema17.properties.component.enum },
          message: 'must be equal to one of the allowed values',
        };
        if (vErrors === null) {
          vErrors = [err7];
        ...
        if (data2.operator !== undefined) {
          ...
          if (
            ...
            const err15 = {
              ...
              keyword: 'enum',
              params: { allowedValues: schema34.properties.operator.enum },
              message: 'must be equal to one of the allowed values',
            };
            if (vErrors === null) {
              vErrors = [err15];
        ...
        if (data2.value !== undefined) {
          ...
          if (
            ...
            const err16 = {
              ...
              keyword: 'type',
              params: { type: schema34.properties.value.type },
    ...
    if (data.join !== undefined) {
      ...
      if (!(data0 === 'OR' || data0 === 'AND')) {
        const err3 = {
          ...
          keyword: 'enum',
          params: { allowedValues: schema32.properties.join.enum },
          message: 'must be equal to one of the allowed values',
        };
        if (vErrors === null) {
          vErrors = [err3];
    ...
    if (data.dataSource !== undefined) {
      ...
      if (typeof data3 !== 'string' && data3 !== null) {
        const err6 = {
          ...
          keyword: 'type',
          params: { type: schema31.properties.dataSource.type },
        ...
        if (data0.value !== undefined) {
          ...
          if (
            ...
            const err4 = {
              ...
              keyword: 'type',
              params: { type: schema37.properties.value.type },
              message: 'must be integer,string,array,boolean',
            };
            if (vErrors === null) {
              vErrors = [err4];
...
function validate45(
  ...
  if (data && typeof data == 'object' && !Array.isArray(data)) {
    ...
    if (data.additionalAttributes !== undefined) {
      if (
        !validate46(data.additionalAttributes, {
    ...
    if (data.action !== undefined) {
      ...
      if (!(data0 === 'SHOW' || data0 === 'SKIP')) {
        const err4 = {
          ...
          keyword: 'enum',
          params: { allowedValues: schema54.properties.action.enum },
          message: 'must be equal to one of the allowed values',
        };
        if (vErrors === null) {
          vErrors = [err4];
              ...
              if (data.type !== undefined) {
                ...
                if (
                  ...
                  const err15 = {
                    ...
                    keyword: 'enum',
                    params: {
                      allowedValues: schema26.anyOf[5].properties.type.enum,
                    },
                    message: 'must be equal to one of the allowed values',
                  };
                  if (vErrors === null) {
    ...
    if (data.type !== undefined) {
      ...
      if (
        ...
        const err23 = {
          ...
          schemaPath: '#/properties/type/enum',
          keyword: 'enum',
          params: { allowedValues: schema26.properties.type.enum },
          message: 'must be equal to one of the allowed values',
        };
        if (vErrors === null) {
          vErrors = [err23];
    ...
    if (data.quickAdd !== undefined) {
      ...
      if (typeof data10 !== 'string' && data10 !== null) {
        const err25 = {
          ...
          keyword: 'type',
          params: { type: schema26.properties.quickAdd.type },
          message: 'must be string,null',
        };
        if (vErrors === null) {
          vErrors = [err25];
    ...
    if (data.dataSource !== undefined) {
      ...
      if (typeof data11 !== 'string' && data11 !== null) {
        const err26 = {
          ...
          schemaPath: '#/properties/dataSource/type',
          keyword: 'type',
          params: { type: schema26.properties.dataSource.type },
          message: 'must be string,null',
        };
        if (vErrors === null) {
          vErrors = [err26];
