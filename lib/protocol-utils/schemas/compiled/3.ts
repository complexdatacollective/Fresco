...
const schema99 = {
  ...
  definitions: {
    ...
    AdditionalAttribute: {
      ...
      properties: {
        variable: { type: 'string' },
        value: { type: ['integer', 'string', 'array', 'boolean'] },
      },
    ...
    Value: { anyOf: [{ type: 'integer' }, { type: 'string' }], title: 'Value' },
    ...
    if (data.type !== undefined) {
      ...
      if (
        ...
        const err5 = {
          ...
          keyword: 'enum',
          params: { allowedValues: schema105.properties.type.enum },
    ...
    if (data.component !== undefined) {
      ...
      if (
        ...
        const err7 = {
          ...
          keyword: 'enum',
          params: { allowedValues: schema105.properties.component.enum },
          message: 'must be equal to one of the allowed values',
        };
        if (vErrors === null) {
          vErrors = [err7];
        ...
        if (data2.operator !== undefined) {
          ...
          if (
            ...
            const err15 = {
              ...
              keyword: 'enum',
              params: { allowedValues: schema122.properties.operator.enum },
              message: 'must be equal to one of the allowed values',
            };
            if (vErrors === null) {
              vErrors = [err15];
        ...
        if (data2.value !== undefined) {
          ...
          if (
            ...
            const err16 = {
              ...
              keyword: 'type',
              params: { type: schema122.properties.value.type },
    ...
    if (data.join !== undefined) {
      ...
      if (!(data0 === 'OR' || data0 === 'AND')) {
        const err3 = {
          ...
          keyword: 'enum',
          params: { allowedValues: schema120.properties.join.enum },
          message: 'must be equal to one of the allowed values',
        };
        if (vErrors === null) {
          vErrors = [err3];
    ...
    if (data.dataSource !== undefined) {
      ...
      if (typeof data3 !== 'string' && data3 !== null) {
        const err6 = {
          ...
          keyword: 'type',
          params: { type: schema119.properties.dataSource.type },
        ...
        if (data0.value !== undefined) {
          ...
          if (
            ...
            const err4 = {
              ...
              keyword: 'type',
              params: { type: schema125.properties.value.type },
              message: 'must be integer,string,array,boolean',
            };
            if (vErrors === null) {
              vErrors = [err4];
            } else {
...
function validate156(
  ...
  if (data && typeof data == 'object' && !Array.isArray(data)) {
    ...
    if (data.additionalAttributes !== undefined) {
      if (
        !validate157(data.additionalAttributes, {
    ...
    if (data.action !== undefined) {
      ...
      if (!(data0 === 'SHOW' || data0 === 'SKIP')) {
        const err4 = {
          ...
          keyword: 'enum',
          params: { allowedValues: schema142.properties.action.enum },
          message: 'must be equal to one of the allowed values',
        };
        if (vErrors === null) {
          vErrors = [err4];
    ...
    if (data && typeof data == 'object' && !Array.isArray(data)) {
      ...
      if (data.createEdge === undefined) {
        const err5 = {
          ...
          schemaPath: '#/anyOf/1/required',
          keyword: 'required',
          params: { missingProperty: 'createEdge' },
          message: "must have required property '" + 'createEdge' + "'",
        };
        if (vErrors === null) {
          vErrors = [err5];
        } else {
                ...
                if (data.type !== undefined) {
                  ...
                  if (
                    ...
                    const err19 = {
                      ...
                      keyword: 'enum',
                      params: {
                        allowedValues: schema114.anyOf[6].properties.type.enum,
                      },
                      message: 'must be equal to one of the allowed values',
                    };
                    if (vErrors === null) {
    ...
    if (data.type !== undefined) {
      ...
      if (
        ...
        const err27 = {
          ...
          schemaPath: '#/properties/type/enum',
          keyword: 'enum',
          params: { allowedValues: schema114.properties.type.enum },
          message: 'must be equal to one of the allowed values',
        };
        if (vErrors === null) {
          vErrors = [err27];
    ...
    if (data.quickAdd !== undefined) {
      ...
      if (typeof data11 !== 'string' && data11 !== null) {
        const err29 = {
          ...
          keyword: 'type',
          params: { type: schema114.properties.quickAdd.type },
          message: 'must be string,null',
        };
        if (vErrors === null) {
          vErrors = [err29];
    ...
    if (data.dataSource !== undefined) {
      ...
      if (typeof data13 !== 'string' && data13 !== null) {
        const err31 = {
          ...
          schemaPath: '#/properties/dataSource/type',
          keyword: 'type',
          params: { type: schema114.properties.dataSource.type },
          message: 'must be string,null',
        };
        if (vErrors === null) {
          vErrors = [err31];
