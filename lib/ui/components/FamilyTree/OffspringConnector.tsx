...
const FamilyTreeOffspringConnector = forwardRef<HTMLDivElement, { xPos: number, yStartPos: number, yEndPos: number }>((props, ref) => {
  const {
    xPos = 0,
    yStartPos = 0,
    yEndPos = 0,
  ...
  return (
    <div className={classes} ref={ref}>
      <svg version="1.1" xmlns="http://www.w3.org/2000/svg">
        ...
        <line x1={xPos} y1={yStartPos} x2={xPos} y2={yEndPos} stroke="#666" />
      </svg>
    </div>
  );
});
