  ...
  render() {
    return (
      ...
      >
        ...
        <path
          className="cls-2"
          d="M450.147 80.005l-4.172 4.172-13.803-13.803 4.172-4.171z"
        />
        <circle
          className="cls-2"
          cx="434.25"
          cy="68.28"
          r="2.95"
          transform="rotate(-45 434.251 68.277)"
        />
        <path
          className="cls-2"
          d="M436.342 93.801l-4.172-4.171 9.645-9.645 4.172 4.172z"
        />
        <circle
          className="cls-2"
          cx="434.25"
          cy="91.72"
          r="2.95"
          transform="rotate(-45 434.26 91.714)"
        />
