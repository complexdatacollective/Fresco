...
import {
  cancelDialog,
  confirmDeletion,
  fillDialogFieldByIndex,
  fillDialogFieldByPlaceholder,
  getDialog,
  openDialog,
  submitDialog,
  waitForDialog,
...
test.describe.serial('Participants page - serial', () => {
  ...
  test('should add a new participant', async ({ page, database }) => {
    ...
    try {
      ...
      await fillDialogFieldByPlaceholder(
        page,
      ...
      await fillDialogFieldByIndex(page, 1, `New Participant ${timestamp}`);
  ...
  test('should edit participant information', async ({ page, database }) => {
    ...
    try {
      ...
      await fillDialogFieldByIndex(page, 1, newLabel);
