// TODO: Needs to be reconciled with the frontend config.ts
...
const DEVICE_API_VERSION = 3; // X-Device-API-Version

const APP_SUPPORTED_SCHEMA_VERSIONS: Array<Protocol["schemaVersion"]> = [7, 8];
