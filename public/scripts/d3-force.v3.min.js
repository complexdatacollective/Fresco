...
!(function (n, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ? define(['exports', 'd3-quadtree', 'd3-dispatch', 'd3-timer'], t)
      : t(
  ...
  (n.forceCenter = function (n, t) {
    ...
    function i() {
      ...
      for (f = (f / o - n) * r, a = (a / o - t) * r, i = 0; i < o; ++i)
        ((u = e[i]).x -= f), (u.y -= a);
    }
    return (
      null == n && (n = 0),
    ...
    (n.forceLink = function (n) {
        ...
        for (var i = 0, o = n.length; i < d; ++i)
          for (var a, c, h, v, y, g, x, s = 0; s < o; ++s)
            (c = (a = n[s]).source),
              ...
              (v *= g =
                (((g = Math.sqrt(v * v + y * y)) - e[s]) / g) * r * t[s]),
              (y *= g),
              (h.vx -= v * (x = f[s])),
              (h.vy -= y * x),
              (c.vx += v * (x = 1 - x)),
      ...
      function x() {
        if (r) {
          ...
          for (i = 0, f = new Array(l); i < l; ++i)
            (u = n[i]),
              (f[i] =
                o[u.source.index] / (o[u.source.index] + o[u.target.index]));
      ...
      return (
        ...
        (g.strength = function (n) {
          return arguments.length
            ? ((v = 'function' == typeof n ? n : i(+n)), s(), g)
            : v;
        }),
        (g.distance = function (n) {
          return arguments.length
            ? ((y = 'function' == typeof n ? n : i(+n)), p(), g)
            : y;
        }),
        g
      );
      ...
      function g() {
        if (n) {
          var t,
            e,
            r = n.length;
          for (f = new Array(r), t = 0; t < r; ++t)
            (e = n[t]), (f[e.index] = +a(e, t, n));
        }
      }
      function x(n) {
        var t,
    ...
    (n.forceRadial = function (n, t, e) {
      ...
      function c() {
        if (r) {
          var t,
            e = r.length;
          for (u = new Array(e), o = new Array(e), t = 0; t < e; ++t)
            (o[t] = +n(r[t], t, r)), (u[t] = isNaN(o[t]) ? 0 : +f(r[t], t, r));
        }
      }
      return (
        ...
        (a.strength = function (n) {
          return arguments.length
            ? ((f = 'function' == typeof n ? n : i(+n)), c(), a)
            : f;
        }),
        (a.radius = function (t) {
          return arguments.length
            ? ((n = 'function' == typeof t ? t : i(+t)), c(), a)
            : n;
        }),
        (a.x = function (n) {
        ...
        for (var h = 0; h < e; ++h)
          for (
            ...
            null == (u = n[r]).fx
              ? (u.x += u.vx *= a)
              : ((u.x = u.fx), (u.vx = 0)),
              null == u.fy ? (u.y += u.vy *= a) : ((u.y = u.fy), (u.vy = 0));
        return t;
      }
      function s() {
        ...
        (t = {
          ...
          force: function (n, e) {
            return arguments.length > 1
              ? (null == e ? c.delete(n) : c.set(n, p(e)), t)
              : c.get(n);
          },
          find: function (t, e, r) {
            var i,
    ...
    (n.forceX = function (n) {
      ...
      function f() {
        if (t) {
          var i,
            o = t.length;
          for (e = new Array(o), r = new Array(o), i = 0; i < o; ++i)
            e[i] = isNaN((r[i] = +n(t[i], i, t))) ? 0 : +u(t[i], i, t);
        }
      }
      return (
        ...
        (o.strength = function (n) {
          return arguments.length
            ? ((u = 'function' == typeof n ? n : i(+n)), f(), o)
            : u;
        }),
        (o.x = function (t) {
          return arguments.length
            ? ((n = 'function' == typeof t ? t : i(+t)), f(), o)
            : n;
        }),
        o
      );
