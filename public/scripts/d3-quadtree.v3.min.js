...
!(function (t, i) {
  ...
  function i(t, i, e, n) {
    ...
    if (
      ...
      return (x.next = c), r ? (r[_] = x) : (t._root = x), t;
    do {
      (r = r ? (r[_] = new Array(4)) : (t._root = new Array(4))),
        (u = i >= (s = (y + p) / 2)) ? (y = s) : (p = s),
        (l = e >= (h = (d + v) / 2)) ? (d = h) : (v = h);
  ...
  function o(t) {
    for (var i = { data: t.data }, e = i; (t = t.next); )
  ...
  (a.copy = function () {
    var t,
      i,
      e = new h(this._x, this._y, this._x0, this._y0, this._x1, this._y1),
      n = this._root;
    if (!n) return e;
    if (!n.length) return (e._root = o(n)), e;
    for (t = [{ source: n, target: (e._root = new Array(4)) }]; (n = t.pop()); )
      for (var r = 0; r < 4; ++r)
        (i = n.source[r]) &&
          (i.length
            ? t.push({ source: i, target: (n.target[r] = new Array(4)) })
            : (n.target[r] = o(i)));
    return e;
  }),
    (a.add = function (t) {
    ...
    (a.cover = function (t, i) {
      ...
      var e = this._x0,
        ...
        s = this._y1;
      if (isNaN(e))
        (r = (e = Math.floor(t)) + 1), (s = (n = Math.floor(i)) + 1);
      else {
        for (
          var h, o, a = r - e || 1, u = this._root;
          e > t || t >= r || n > i || i >= s;
      ...
      return (
        (this._x0 = e), (this._y0 = n), (this._x1 = r), (this._y1 = s), this
      );
    }),
    (a.data = function () {
      var t = [];
    ...
    (a.find = function (t, i, n) {
      var r,
        ...
        d = this._root;
      for (
        d && y.push(new e(d, _, f, c, x)),
          null == n
            ? (n = 1 / 0)
            : ((_ = t - n), (f = i - n), (c = t + n), (x = i + n), (n *= n));
        (u = y.pop());
    ...
    (a.remove = function (t) {
      ...
      return (
        (r = c.next) && delete c.next,
        n
          ? (r ? (n.next = r) : delete n.next, this)
          : i
            ? (r ? (i[_] = r) : delete i[_],
              (c = i[0] || i[1] || i[2] || i[3]) &&
                c === (i[3] || i[2] || i[1] || i[0]) &&
                !c.length &&
                (e ? (e[f] = c) : (this._root = c)),
              this)
            : ((this._root = r), this)
      );
    }),
    ...
    (a.visit = function (t) {
      var i,
        ...
        u = this._root;
      for (
        u && a.push(new e(u, this._x0, this._y0, this._x1, this._y1));
        (i = a.pop());

      )
        if (
          !t((u = i.node), (r = i.x0), (s = i.y0), (h = i.x1), (o = i.y1)) &&
          u.length
        ) {
          var l = (r + h) / 2,
            _ = (s + o) / 2;
          (n = u[3]) && a.push(new e(n, l, _, h, o)),
            (n = u[2]) && a.push(new e(n, r, _, l, o)),
            (n = u[1]) && a.push(new e(n, l, s, h, _)),
            (n = u[0]) && a.push(new e(n, r, s, l, _));
        }
      return this;
    }),
    (a.visitAfter = function (t) {
      ...
      for (
        this._root &&
        n.push(new e(this._root, this._x0, this._y0, this._x1, this._y1));
        (i = n.pop());
        ...
        if (s.length) {
          var h,
            ...
            _ = (o + u) / 2,
            f = (a + l) / 2;
          (h = s[0]) && n.push(new e(h, o, a, _, f)),
            (h = s[1]) && n.push(new e(h, _, a, u, f)),
            (h = s[2]) && n.push(new e(h, o, f, _, l)),
            (h = s[3]) && n.push(new e(h, _, f, u, l));
        }
        r.push(i);
      }
